...
@PluginDescriptor(
		name = "Free Utils",
		description = "Utilities required for FREE plugins to function",
		hidden = false
)
@Slf4j
@SuppressWarnings("unused")
@Singleton
public class FreeUtils extends Plugin
{
	@Inject
	...
	@Provides
	AUtilsConfig provideConfig(ConfigManager configManager)
	{
